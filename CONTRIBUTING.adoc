...
You can  likewise submit a new (bug-)issue by sending it to link:mailto:contact-project+greluc-oss-sc-sc-kill-monitor-support@incoming.gitlab.com[contact-project+greluc-oss-sc-sc-kill-monitor-support@incoming.gitlab.com].
...
You can likewise submit a new (feature-)issue by sending it to link:mailto:contact-project+greluc-oss-sc-sc-kill-monitor-support@incoming.gitlab.com[contact-project+greluc-oss-sc-sc-kill-monitor-support@incoming.gitlab.com].
...
You can find the XML file for IntelliJ IDEA in the config/settings directory.
